...
public class MarkerData {
	...
	markable.put("gfx/tiles/ridges/cavein", new LinkedMarker("Cave (Surface)", "gfx/hud/mmap/cave", Type.LINKED, MapFile.CAVE));
        markable.put("gfx/tiles/ridges/caveout", new LinkedMarker("Cave (L1)", "gfx/hud/mmap/cave", Type.LINKED, MapFile.CAVEIN));
    }
