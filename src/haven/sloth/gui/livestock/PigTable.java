...
public class PigTable extends AnimalTable {
    public PigTable() {
        super();
        setHeader(makeSimpleLabelRow("Mug shot", "Name", "Sex", "Brand", "Pregnant", "Quality", "Meat quantity", "Milk quantity", "Truffle snout",
                "Meat quality", "Milk quality", "Hide quality", "Breeding quality", "Satiety", "Wellfedness"));
    }
    ...
    public void addAnimal(final Window animal, final boolean male) {
        ...
        final Widget truffle = scan(ava, "Truffle snout:").next;
        ...
        final Row row = generateRow(ava, name, sex, brand, preg, quality, meatAmt, milkAmt, truffle, meatq, milkq, hideq, breedq,
                satiety, fedness, mark, kill, close);
