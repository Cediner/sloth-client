...
public class PigTable extends AnimalTable {
    public PigTable() {
        super();
        setHeader(makeSimpleLabelRow("Mug shot", "Name", "Brand", "Pregnant", "Quality", "Meat quantity", "Milk quantity", "Truffle snout",
    ...
    public void addAnimal(final Window animal) {
        ...
        final Row row = generateRow(ava, name, brand, preg, quality, meatAmt, milkAmt, truffle, meatq, milkq, hideq, breedq,
                satiety, fedness, mark, close);
