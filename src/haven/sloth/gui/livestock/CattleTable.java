...
public class CattleTable extends AnimalTable {
    public CattleTable() {
        super();
        setHeader(makeSimpleLabelRow("Mug shot", "Name", "Brand", "Pregnant", "Quality", "Meat quantity", "Milk quantity",
    ...
    public void addAnimal(final Window animal) {
        ...
        final Row row = generateRow(ava, name, brand, preg, quality, meatAmt, milkAmt, meatq, milkq, hideq, breedq,
