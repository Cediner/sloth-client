...
public class CattleTable extends AnimalTable {
    public CattleTable() {
        super();
        setHeader(makeSimpleLabelRow("Mug shot", "Name", "Sex", "Brand", "Pregnant", "Quality", "Meat quantity", "Milk quantity",
    ...
    public void addAnimal(final Window animal, final boolean male) {
        ...
        final Row row = generateRow(ava, name, sex, brand, preg, quality, meatAmt, milkAmt, meatq, milkq, hideq, breedq,
